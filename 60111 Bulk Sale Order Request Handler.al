codeunit 60111 "Bulk SO Request Handler"
{
    trigger OnRun()
    begin
    ...
    procedure GetBulkSaleOrders()
    var
        SellerCloudSetup: Record "Seller Cloud Setup";
        BulkSOResponseHandler: Codeunit "Bulk SO Response Handler";
    ...
    begin
        ...
        _URL := SellerCloudSetup."SO URL" + '?pageNumber=' + Format(PageNoInteger) + '&pageSize=50' + '&orderStatus=' + OrderStatus;
        ...
        if _IsSucessfull then begin
            ...
            BulkSOResponseHandler.StoreSaleOrders(_Response);
        end;
